# -*- coding: utf-8 -*-
# @Author: liangou
# @Date:   2021-01-22 01:05:02
# @Last Modified by:   liangou
# @Last Modified time: 2021-01-22 01:22:07
from torch.utils.data import DataLoader,Dataset
from step3_train_model.pytorch.model.layers import Inception_ResNetv2
import torch.nn as nn
import torch
import torch.nn.functional as F
class DENAModel_test(nn.Module):
	def __init__(self, in_dim, hidden_dim, n_layer, n_classes,drop_out=False):
		super(DENAModel_test, self).__init__()
