...
class DENADataLoader(BaseDataLoader):
	...
	"""
    def __init__(self, hdf5_dir,file_list,dataset,batch_size=64, shuffle=True, validation_split=0.3, num_workers=1, training=True,features=None,windows_len-=21,balance_signal=False):
